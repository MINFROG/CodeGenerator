...
public class ${tableMetaInfoDto.clsName}ServiceImpl implements ${tableMetaInfoDto.clsName}Service {
	 ...
	 */
	public void insert(${tableMetaInfoDto.clsName}Dto ${tableMetaInfoDto.clsName?uncap_first}Dto) {
		try{
			...
			throw new ${conf.serviceExceptionSimpleName}("这里填写错误信息。。。。", "这里填写错误代码，错误代码以常量形式定义（如：ExceptionCode.XXX_XXX_XXX_XXX）");	//TODO
		}
	}
	 ...
	 * @throws ${conf.serviceExceptionSimpleName}
	 */
	public int deleteById(${tableMetaInfoDto.primaryFieldJavaTypeName} ${tableMetaInfoDto.primaryPropertieName}) {
		try{
			return ${tableMetaInfoDto.clsName?uncap_first}Dao.deleteByPK(${tableMetaInfoDto.primaryPropertieName});
		}catch(Exception e){
	 ...
	 * @throws ${conf.serviceExceptionSimpleName}
	 */
	public int update(${tableMetaInfoDto.clsName}Dto ${tableMetaInfoDto.clsName?uncap_first}Dto) {
		try{
			${tableMetaInfoDto.clsName} ${tableMetaInfoDto.clsName?uncap_first} = new ${tableMetaInfoDto.clsName}();
			dto2EntityCopier.copy(${tableMetaInfoDto.clsName?uncap_first}Dto, ${tableMetaInfoDto.clsName?uncap_first}, null);
			return ${tableMetaInfoDto.clsName?uncap_first}Dao.update(${tableMetaInfoDto.clsName?uncap_first});
		}catch(Exception e){
	 ...
	 * @throws ${conf.serviceExceptionSimpleName}
	 */
	public ${tableMetaInfoDto.clsName}Dto queryById(${tableMetaInfoDto.primaryFieldJavaTypeName} ${tableMetaInfoDto.primaryPropertieName}) {
		try{
	 ...
	 * @throws ${conf.serviceExceptionSimpleName}
	 */
	public List<${tableMetaInfoDto.clsName}Dto> queryByExampleForList(${tableMetaInfoDto.clsName}Dto ${tableMetaInfoDto.clsName?uncap_first}Dto) {
		try{
			${tableMetaInfoDto.clsName} ${tableMetaInfoDto.clsName?uncap_first} = new ${tableMetaInfoDto.clsName}();
			dto2EntityCopier.copy(${tableMetaInfoDto.clsName?uncap_first}Dto, ${tableMetaInfoDto.clsName?uncap_first}, null);
	 ...
	 * @throws ${conf.serviceExceptionSimpleName}
	 */
	public ${conf.paginationListSimpleName}<${tableMetaInfoDto.clsName}Dto> queryByExampleForPage(${tableMetaInfoDto.clsName}Dto ${tableMetaInfoDto.clsName?uncap_first}Dto, int pageNum, int pageSize) {
		try{
			${tableMetaInfoDto.clsName} ${tableMetaInfoDto.clsName?uncap_first} = new ${tableMetaInfoDto.clsName}();
			dto2EntityCopier.copy(${tableMetaInfoDto.clsName?uncap_first}Dto, ${tableMetaInfoDto.clsName?uncap_first}, null);
